        ...
        <>
          ...
          >
            <motion.div className="w-full max-w-3xl glass-card-pillar rounded-3xl overflow-hidden border border-white/40 relative">
              ...
              <button
                onClick={onClose}
                className="absolute top-16 left-1/2 -translate-x-1/2 md:left-auto md:right-6 md:translate-x-0 z-10 p-2 glass-element rounded-full transition hover:glass-card-pillar-hover"
              >
